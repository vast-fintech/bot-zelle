        ...
        while TRUE:
            ...
            if claims > 0:
                ...
                for row in transact_dict:
                    ...
                    if  fuzz.ratio(str(bank_name),str(desk_name))>=69 and row['Fecha'] == datetime.today().date() and discrepancy < cascade and str(row['Remitente Desk'])=='POR PAGAR':
                        ...
                        confirmar()
                        break
                    elif  fuzz.ratio(str(bank_name2),str(desk_name))>=69 and row['Fecha'] == datetime.today().date() and discrepancy < cascade and str(row['Remitente Desk'])=='POR PAGAR':
                        print('Transacción encontrada')
                        print(frame())
                        try:
                            gapi(3).sheets(frame(),'G',index)
                        ...
                        confirmar()
                        break
                    elif  fuzz.ratio(str(bank_name),str(desk_name2))>=69 and row['Fecha'] == datetime.today().date() and discrepancy < cascade and str(row['Remitente Desk'])=='POR PAGAR':
                        print('Transacción encontrada')
                        print(frame())
                        try:
                            gapi(3).sheets(frame(),'G',index)
                        ...
                        confirmar()
                        break
                    elif  fuzz.ratio(str(bank_name2),str(desk_name2))>=65 and row['Fecha'] == datetime.today().date() and discrepancy < cascade and str(row['Remitente Desk'])=='POR PAGAR':
                        print('Transacción encontrada')
                        print(frame())
                        try:
                            gapi(3).sheets(frame(),'G',index)
